    ...
    return (
        $e(() => {
            const E = i.page.subscribe(() => {
                a &&
                    (t(5, (d = !0)),
                    t(6, (L = document.title || 'untitled page')))
            })
            return t(4, (a = !0)), E
        }),
        (s.$$set = (E) => {
...
const bt = 'modulepreload',
    ...
    fe = [
        () =>
            be(
                () => import('./layout.svelte-5ca4633e.js'),
                ['layout.svelte-5ca4633e.js', 'chunks/index-e6474461.js']
            ),
        () =>
            be(
                () => import('./error.svelte-0f016f50.js'),
                ['error.svelte-0f016f50.js', 'chunks/index-e6474461.js']
            ),
        () =>
            be(
                () => import('./pages/index.svelte-0c9d21dd.js'),
                [
                    'pages/index.svelte-0c9d21dd.js',
                    'assets/pages/index.svelte-f5e16c38.css',
                    'chunks/index-e6474461.js',
                ]
            ),
    ],
    $t = { '': [[0, 2], [1]] }
...
function Ut(s, e) {
    ...
    e &&
        ...
        (i += `[sveltekit\\:data-body="${St(e.body)}"]`)
...
function Tt({ target: s, session: e, base: t, trailing_slash: i }) {
        ...
        if (!a.url || o.href !== a.url.href || a.error !== b || a.stuff !== w) {
            ...
            const g = (O, k) => {
                Object.defineProperty(R.props.page, O, {
                    get: () => {
                        throw new Error(
                            `$page.${O} has been replaced by $page.url.${k}`
                        )
                    },
                })
            }
        ...
        e: for (let k = 0; k < b.length; k += 1) {
            ...
            try {
                ...
                if (
                    ...
                    Array.from(I.uses.dependencies).some((W) =>
                        c.some((ce) => ce(W))
                    ) ||
                    (N && I.uses.stuff)
                ) {
                    ...
                    if (
                        ...
                        if (
                            (A.loaded.error &&
                                (($ = A.loaded.status), (y = A.loaded.error)),
                            A.loaded.redirect)
                        )
                            return {
                                redirect: A.loaded.redirect,
                                props: {},
                                state: a,
                            }
                        A.loaded.stuff && (N = !0)
    ...
    async function Q({ status: o, error: p, url: w, routeId: u }) {
        ...
        return await _e({
            ...
            params: h,
            stuff: {
                ...((_ = b == null ? void 0 : b.loaded) == null
                    ? void 0
                    : _.stuff),
                ...((m = v == null ? void 0 : v.loaded) == null
                    ? void 0
                    : m.stuff),
            },
            branch: [b, v],
    ...
    return {
        ...
        prefetch_routes: async (o) => {
            const w = (o ? ye.filter((u) => o.some((h) => u.exec(h))) : ye).map(
                (u) => Promise.all(u.a.map((h) => h()))
            )
            await Promise.all(w)
        },
        _start_router: () => {
            ...
            const w = (u) => {
                clearTimeout(p),
                    (p = setTimeout(() => {
                        ...
                        ;(h = u.target) == null ||
                            h.dispatchEvent(
                                new CustomEvent('sveltekit:trigger_prefetch', {
                                    bubbles: !0,
                                })
                            )
                    }, 20))
            ...
            addEventListener('touchstart', o),
                ...
                addEventListener('click', (u) => {
                    ...
                    me({
                        url: v,
                        scroll: h.hasAttribute('sveltekit:noscroll')
                            ? ke()
                            : null,
                        keepfocus: !1,
                        redirect_chain: [],
                        details: {
                            state: {},
                            replaceState: v.href === location.href,
                        },
        ...
        _hydrate: async ({
            ...
            try {
                for (let S = 0; S < w.length; S += 1) {
                    ...
                    if (
                        ($ &&
                            (y.uses.dependencies.add(b.href),
                            (y.uses.url = !0)),
                        v.push(y),
                        y && y.loaded)
                    )
                        if (y.loaded.error) {
                            ...
                            y.loaded.stuff && (_ = { ..._, ...y.loaded.stuff })
                }
                m = R
                    ? await Q(R)
                    : await _e({
